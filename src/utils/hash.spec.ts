...
const mock = {
  current_total: null as number,
  current_unit_cost: null as number,
  current_units: null as number,
  id: '59902',
  invoice_id: '890',
  last_touch: null as string,
  lds_activity_code: 'A101',
  lds_adjustment: null as number,
  lds_date: '2015-09-01',
  lds_description: 'Draft initial complaint',
  lds_expense_code: null as string,
  lds_line_id: '2',
  lds_task_code: 'L200',
  ...
  matter: null as object,
  mavenCode: { id: '1', custom: '', path: ['generalCode'] },
  tagged_lds_description: null as string,
  timekeeper: null as object,
  vendor: null as object,
};
